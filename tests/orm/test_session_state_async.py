...
async def test_new_reflects_staged_adds(async_session):
    s = async_session
    assert s.new == []
...
async def test_new_empty_after_flush(async_session):
    s = async_session
...
async def test_dirty_reflects_field_changes(async_session):
    s = async_session
...
async def test_dirty_deduplicates_multiple_field_changes(async_session):
    s = async_session
...
async def test_dirty_empty_after_flush(async_session):
    s = async_session
...
async def test_deleted_reflects_staged_deletes(async_session):
    s = async_session
...
async def test_deleted_empty_after_flush(async_session):
    s = async_session
...
async def test_state_properties_return_shallow_copies(async_session):
    s = async_session
